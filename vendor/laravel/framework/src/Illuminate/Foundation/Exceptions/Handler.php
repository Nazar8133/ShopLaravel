...
class Handler implements ExceptionHandlerContract
{
    ...
    protected function unauthenticated($request, AuthenticationException $exception)
    {
        ...
        if ($guard=='buyer'){
            return redirect()->guest(route('index.user'))->withErrors('Для того щоб виконати цю дію ви повинні залогінитись!');
        }
        elseif ($guard=='web'){
            return redirect()->guest(route('login'))->withErrors('Для того щоб виконати цю дію ви повинні залогінитись!');
        }
        else{
            return redirect()->back()->withErrors(['errorGuest'=>'Для того щоб виконати цю дію ви повинні залогінитись!']);
        }
    }
